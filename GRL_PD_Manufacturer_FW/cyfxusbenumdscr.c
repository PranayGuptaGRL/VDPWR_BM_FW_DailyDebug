...
const uint8_t CyFxUSB30DeviceDscr[] __attribute__ ((aligned (32))) =
{
    ...
    0x20,0x03,                      /* USB 3.1 *//*Pranay : USB 3.2 need to be used as per USB Spec*/
    0x00,                           /* Device class */
...
const uint8_t CyFxUSBBOSDscr[] __attribute__ ((aligned (32))) =
{
    ...
    0xFF,0xFF                       /* U2 Device Exit latency */
};
...
//    0x80,                           /* Config characteristics - Bus powered */
    0x40,                           /* Config characteristics - Self powered *//*Pranay : Device made as Self powered only*/
    0x0A,                           /* Max power consumption of device (in 8mA unit) : 400mA */
    ...
    0x0F,                           /* Max no. of packets in a burst : 0: burst 1 packet at a time (15 packet)*/
...
//    0x80,                           /* Config characteristics - bus powered */
    0x40,                           /* Config characteristics - Self powered *//*Pranay : Device made as Self powered only*/
    0x28,                           /* Max power consumption of device (in 2mA unit) : 100mA */
...
/* Standard product Serial number string descriptor */
uint8_t CyFxUSBProductSerNumDscr[] __attribute__ ((aligned (32))) =
{
...
void SetProductSerNumDesc(uint8_t *lBuf)
{
	CyFxUSBProductSerNumDscr[2] = lBuf[1];
	CyFxUSBProductSerNumDscr[4] = lBuf[2];
	CyFxUSBProductSerNumDscr[6] = lBuf[3];
	CyFxUSBProductSerNumDscr[8] = lBuf[4];
	CyFxUSBProductSerNumDscr[10] = lBuf[5];
	CyFxUSBProductSerNumDscr[12] = lBuf[6];
	CyFxUSBProductSerNumDscr[14] = lBuf[7];
	CyFxUSBProductSerNumDscr[16] = lBuf[8];
	CyFxUSBProductSerNumDscr[18] = lBuf[9];
	CyFxUSBProductSerNumDscr[22] = lBuf[10];
	CyFxUSBProductSerNumDscr[24] = lBuf[11];
}
