// ======================================================================
// CYPD3171-24LQXQ_pb.v generated from TopDesign.cysch
// 12/13/2021 at 16:19
...
module top ;
	...
	wire [0:0] tmpOE__DIR_CTRL_C_net;
	wire [0:0] tmpFB_0__DIR_CTRL_C_net;
	wire [0:0] tmpIO_0__DIR_CTRL_C_net;
	wire [0:0] tmpINTERRUPT_0__DIR_CTRL_C_net;
	electrical [0:0] tmpSIOVREF__DIR_CTRL_C_net;

	cy_psoc3_pins_v1_10
		#(.id("216e9ee8-2a12-4be2-8302-8276323df135"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DIR_CTRL_C
		 (.oe(tmpOE__DIR_CTRL_C_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIR_CTRL_C_net[0:0]}),
		  .io({tmpIO_0__DIR_CTRL_C_net[0:0]}),
		  .siovref(tmpSIOVREF__DIR_CTRL_C_net),
		  .interrupt({tmpINTERRUPT_0__DIR_CTRL_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIR_CTRL_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_0 PWMI_C (
        .capture(1'b0),
        .cc(Net_441),
        .clock(Net_410),
        .count(1'b1),
	...
	wire [0:0] tmpOE__PWMI_OUT_C_net;
	wire [0:0] tmpFB_0__PWMI_OUT_C_net;
	wire [0:0] tmpIO_0__PWMI_OUT_C_net;
	wire [0:0] tmpINTERRUPT_0__PWMI_OUT_C_net;
	electrical [0:0] tmpSIOVREF__PWMI_OUT_C_net;

	cy_psoc3_pins_v1_10
		#(.id("e249f86d-190f-49a8-9e4b-c0b847120ecf"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWMI_OUT_C
		 (.oe(tmpOE__PWMI_OUT_C_net),
		  .y({Net_408}),
		  .fb({tmpFB_0__PWMI_OUT_C_net[0:0]}),
		  .io({tmpIO_0__PWMI_OUT_C_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMI_OUT_C_net),
		  .interrupt({tmpINTERRUPT_0__PWMI_OUT_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMI_OUT_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__MasterInput_net;
	wire [0:0] tmpFB_0__MasterInput_net;
	wire [0:0] tmpIO_0__MasterInput_net;
	electrical [0:0] tmpSIOVREF__MasterInput_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		MasterInput
		 (.oe(tmpOE__MasterInput_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MasterInput_net[0:0]}),
		  .io({tmpIO_0__MasterInput_net[0:0]}),
		  .siovref(tmpSIOVREF__MasterInput_net),
		  .interrupt({Net_494}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__MasterInput_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
