...
/**< Timer ID allocation range for USB module is from 144 (0x90) to 151 (0x95). */

#define USB_SUSPEND_TIMER                       (USB_TIMER_ID_BASE + 0)
/**< This timer is used to check for USB bus suspend condition. */
...
#define USB_REMOTE_WAKEUP_TIMER                 (USB_TIMER_ID_BASE + 1)
/**< This timer is used to signal remote wakeup. */
