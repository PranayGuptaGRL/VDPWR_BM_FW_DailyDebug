...
#define GRL_PPS_TIMER_HANDLE    (1u)
...
uint32_t grl_RequestPacketConfig(uint8_t ,uint8_t ,uint32_t , uint32_t , uint32_t );
//static pd_do_t gPrepareRequestPkt(uint8_t pdo_no, bool capMisMatch, bool giveBack, uint32_t op_cur_power, uint32_t max_min_cur_pwr,uint16_t MsgType/*, app_resp_cbk_t app_resp_handler*/);
/** @endcond */


#define SPEC_REV_1_0            0x00//00b
#define SPEC_REV_2_0            0x01//01b
#define SPEC_REV_3_0            0x02//10b
#define GRL_CAPS
#endif /* _PDO_H_ */
