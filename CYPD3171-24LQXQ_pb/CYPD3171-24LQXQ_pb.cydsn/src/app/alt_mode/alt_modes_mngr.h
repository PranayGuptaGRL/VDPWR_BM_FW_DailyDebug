...
/**< USB SuperSpeed signaling value that indicates that cable only supports USB 2.0. */

#define USB_GEN_1_SUPP                  (1u)
/**< USB SuperSpeed signaling value that indicates that cable supports USB 3.1 Gen-1. */

#define USB_GEN_2_SUPP                  (2u)
/**< USB SuperSpeed signaling value that indicates that cable supports USB 3.1 Gen-2. */
...
/**
  @struct comp_tbl_t
  @brief This structure are used in alt_modes_config.h file to set alternate
