 ...
 *
 * This version of the CCGx Firmware Stack supports the CCG3PA and CCG3PA2
 * families and is targeted at implementing USB-PD power adapter and power
 * bank applications.
 *
 * Please refer to the CCGx Host SDK for stack and code examples for implementing
 * USB-PD controller for notebook, desktop and mobile systems.  Please use the CCGx
